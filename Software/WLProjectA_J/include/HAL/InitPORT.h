...
void InitPORTBInput  (T_UBYTE, T_UBYTE);
void InitPORTCInput  (T_UBYTE, T_UBYTE);
void InitPORTDInput  (T_UBYTE, T_UBYTE);
void InitPORTEInput  (T_UBYTE, T_UBYTE);
void InitPORTBOutput (T_UBYTE);
void InitPORTCOutput (T_UBYTE);
void InitPORTDOutput (T_UBYTE);
void InitPORTEOutput (T_UBYTE);
